...
| ------------------------------------------------------------------------- | -------------------------------------------------- | ------------ | ------ | ---------- | --------------------------------------------------------------------------------------------- |
| [P001](phases/P001-local-foundation-and-change-request-vertical-slice.md) | Local Foundation And Change-Request Vertical Slice | `qa_pending` | high   | []         | [active prompt](../prompts/active/P001-local-foundation-and-change-request-vertical-slice.md) |
...
- **P001 — Local Foundation And Change-Request Vertical Slice**: `qa_pending`.
